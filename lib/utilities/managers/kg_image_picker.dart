  ...
  TextStyle get textStyle {
    switch(this) {
      case ImagePickType.remove:
        return GeneralUtility.shared.getTextStyle(color: ColorConst.red, fontSize: 17, myFont: MyFont.medium);
      default:
        return GeneralUtility.shared.getTextStyle(color: ColorConst.black, fontSize: 17, myFont: MyFont.medium);
    }
  }

}

class KGImagePicker extends StatelessWidget {

  final bool showRemove;
  final void Function(ImagePickType, XFile?)? completion;

  const KGImagePicker({Key? key, this.showRemove = true, this.completion}) : super(key: key);
